...
static const uint8_t BookLabelGraphic[288] = {
    ...
    0xFC, 0x3F, 0xFF, 0xBF, 0x5F, 0xFF, 0xFD, 0x98, 0xC7, 0x0B, 0x18, 0x7F, 0xF8, 0xDB, 0x5F, 0xBB,
    0x6B, 0x7F, 0xFD, 0xD3, 0x1F, 0xBA, 0x0B, 0x7F, 0xFD, 0x9B, 0x5F, 0xBB, 0x7B, 0x7F, 0xFC, 0x38,
    0xC7, 0x8B, 0x08, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFB, 0xFF, 0xFF, 0xFC, 0xFF, 0xFF, 0xFB, 0xFF,
};
...
static const uint8_t FolderLabelGraphic[288] = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF9, 0xFF, 0x0D, 0xFF,
    0xE1, 0xFF, 0xF2, 0xDF, 0x7D, 0xFF, 0xEC, 0xDA, 0x68, 0x86, 0x2D, 0x8F, 0xEE, 0xDB, 0x4B, 0x5F,
    0x6D, 0xB7, 0xEE, 0xDB, 0x50, 0x5F, 0x6D, 0x07, 0xEC, 0xDB, 0x1B, 0xDF, 0x6D, 0xBF, 0xE1, 0xC3,
    0xB8, 0x47, 0x6D, 0x87, 0xFF, 0xFF, 0xBF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0x79, 0xFF, 0xFF, 0xFF,
};
...
static const uint8_t RecentLabelGraphic[288] = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xE7, 0xEF, 0xFE, 0xBF, 0xFD, 0x9F, 0x6F, 0xEF, 0xFF, 0x5F, 0xF8, 0x1F,
    0xC6, 0x23, 0xE3, 0x18, 0xF1, 0x8B, 0xF4, 0xE9, 0xCB, 0xDA, 0x65, 0xED, 0x44, 0xE9, 0xCB, 0x1A,
    0x65, 0x8D, 0x14, 0xE9, 0xCA, 0x5A, 0x65, 0x2C, 0x46, 0x29, 0xE3, 0x1A, 0x71, 0x8E, 0xFF, 0xFF,
    0xFB, 0xFF, 0xFF, 0xFC, 0xFF, 0xFF, 0xE3, 0xFF, 0xFF, 0xF9, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
};
...
static const uint8_t LibraryLabelGraphic[288] = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFC, 0x30, 0xC3, 0x0F, 0xFF, 0xFF, 0xFB, 0xB6, 0xD8, 0x7F, 0xFF, 0xFF, 0xFB, 0x96, 0xDD,
    0x3F, 0xFF, 0xFF, 0xFB, 0x90, 0xDD, 0x9F, 0xFF, 0xFF, 0xFB, 0xB7, 0xD8, 0xCF, 0xFF, 0xFF, 0xFC,
    0x37, 0xC2, 0x1F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
};
...
static const uint8_t TransferLabelGraphic[288] = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF5, 0xFF, 0x95, 0xFF, 0xC3, 0xFF, 0xFA, 0xFF, 0xBD, 0xFF,
    0xF6, 0x68, 0xC8, 0x8F, 0x15, 0x8F, 0xF6, 0xE9, 0x52, 0xA7, 0xB5, 0x2F, 0xF6, 0xE9, 0x50, 0xA7,
    0xB5, 0x0F, 0xF6, 0xE9, 0x33, 0xA7, 0xB5, 0x3F, 0xF6, 0xE5, 0xB8, 0xA7, 0xB5, 0x8F, 0xFF, 0xFF,
...
static const uint8_t SettingsLabelGraphic[288] = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0x77, 0xF6, 0x1F, 0xFF, 0xFF, 0xC7, 0x3F, 0xC3, 0xFB, 0xFF,
    0xFF, 0xB6, 0x37, 0x86, 0x30, 0xFF, 0xFF, 0xBF, 0x97, 0xB7, 0x9B, 0xFF, 0xFF, 0xBE, 0x17, 0x36,
    0x1B, 0xFF, 0xFF, 0xBC, 0x97, 0xB4, 0x9B, 0xFF, 0xFF, 0xC6, 0x57, 0x86, 0x58, 0xFF, 0xFF, 0xFF,
...
const uint8_t* menuLabelGraphic(const UIIcon icon) {
  switch (icon) {
...
void drawHomeMenu(GfxRenderer& r, const HomeRenderContext& h) {
  ...
  constexpr int labelSize = 48;
  constexpr int iconLabelGap = 1;
  ...
  for (int i = 0; i < h.menuCount; ++i) {
    ...
    const int contentH = iconSize + iconLabelGap + labelSize;
    const int baseY = top + std::max(0, (height - contentH) / 2);

    const uint8_t* icon = iconBitmap(h.rowIcon(i));
    if (icon) {
      const int iconX = bx + (buttonW - iconSize) / 2;
      r.drawIcon(icon, iconX, baseY, iconSize);
    }

    const uint8_t* label = menuLabelGraphic(h.rowIcon(i));
    if (label) {
      const int labelX = bx + (buttonW - labelSize) / 2;
      r.drawIcon(label, labelX, baseY + iconSize + iconLabelGap, labelSize);
    }
  }
}
