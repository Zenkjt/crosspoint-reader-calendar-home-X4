...
// Menu labels are pre-rendered monochrome graphics (48x48).
// This keeps the menu independent of runtime font rendering.
static const uint8_t BookLabelGraphic[128] = {
    ,
};

static const uint8_t FolderLabelGraphic[128] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF8, 0x00, 0xFF, 0xFF,
    0xF8, 0x00, 0x7F, 0xFF, 0xF8, 0x00, 0x00, 0x1F, 0xF8, 0x00, 0x00, 0x1F, 0xF9, 0xFF, 0xFF, 0x9F,
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xF9, 0xF9, 0x43, 0xFF, 0xFA, 0x21, 0x02, 0x7F, 0xFA, 0x21, 0x52, 0x7F, 0xF9, 0x31, 0x12, 0x7F,
};

static const uint8_t RecentLabelGraphic[128] = {
    ,
};

static const uint8_t LibraryLabelGraphic[128] = {
    ,
};

static const uint8_t TransferLabelGraphic[128] = {
    ,
};

static const uint8_t SettingsLabelGraphic[128] = {
    ,
};
...
void drawBookCard(GfxRenderer& r, const HomeRenderContext& h) {
  ...
  // Keep a clear white safety margin below the gray cover tile.
  // The card ends at y + height (680); the tile must stop before that
  // boundary so its gray fill can never visually merge with the lower frame.
  const int coverAreaY = y + 50;
  const int coverAreaH = 295;
...
const uint8_t* menuGraphic(const UIIcon icon) {
  switch (icon) {
    case Folder: return FolderLabelGraphic;
    case Book: return BookLabelGraphic;
    case Recent: return RecentLabelGraphic;
    case Settings: return SettingsLabelGraphic;
    case Transfer: return TransferLabelGraphic;
    case Library: return LibraryLabelGraphic;
    default: return nullptr;
  }
}
...
void drawHomeMenu(GfxRenderer& r, const HomeRenderContext& h) {
  ...
  // One complete 32x32 graphic per menu item: icon + Vietnamese label.
  // drawIcon() expects the source bitmap to be 32x32 (128 bytes).
  constexpr int graphicSize = 46;
  ...
  for (int i = 0; i < h.menuCount; ++i) {
    ...
    const uint8_t* graphic = menuGraphic(h.rowIcon(i));
    if (graphic) {
      const int gx = bx + (buttonW - graphicSize) / 2;
      const int gy = top + std::max(0, (height - graphicSize) / 2);
      r.drawIcon(graphic, gx, gy, graphicSize);
    }
  }
}
}  // namespace
